...
bool eai_narray_set_test(void)
{
    ...
    for (ulib_uint i = 0; i < 1000; i++) {
        ...
        ulib_uint idx_2[10] = {rand() % 5, rand() % 5, rand() % 5, rand() % 5, rand() % 5, rand() % 5, rand() % 5, rand() % 5, rand() % 5, rand() % 5};
       
        ulib_float old_value_1 = eai_narray_get(ulib_float, &array, idx_1[0], idx_1[1], idx_1[2]);
        ulib_uint old_value_2 = eai_narray_get(ulib_uint, &array2, idx_2[0], idx_2[1], idx_2[2], idx_2[3], idx_2[4], idx_2[5], idx_2[6], idx_2[7], idx_2[8], idx_2[9]); 
        ...
        ulib_float retrieved_value_1 = eai_narray_get(ulib_float, &array, idx_1[0], idx_1[1], idx_1[2]);
        ulib_uint retrieved_value_2 = eai_narray_get(ulib_uint, &array2, idx_2[0], idx_2[1], idx_2[2], idx_2[3], idx_2[4], idx_2[5], idx_2[6], idx_2[7], idx_2[8], idx_2[9]); 
...
bool eai_narray_get_ref_test(void)
{
    ...
    for (ulib_uint i = 0; i < 100; i++) {
        ulib_float *x_1 = eai_narray_get_ref(ulib_float, &array, rand() % 3, rand() % 3, rand() % 3);
        ulib_uint *x_2 = eai_narray_get_ref(ulib_uint, &array2, rand() % 5, rand() % 5, rand() % 5, rand() % 5, rand() % 5, rand() % 5, rand() % 5, rand() % 5, rand() % 5, rand() % 5);
